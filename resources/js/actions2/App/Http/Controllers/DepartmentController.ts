...
/**
* @see \App\Http\Controllers\DepartmentController::toggleStatus
 * @see app/Http/Controllers/DepartmentController.php:342
 * @route '/departments/{department}/toggle-status'
 */
export const toggleStatus = (args: { department: number | { id: number } } | [department: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
toggleStatus.definition = {
    methods: ["post"],
    url: '/departments/{department}/toggle-status',
 ...
 * @route '/departments/{department}/toggle-status'
 */
toggleStatus.post = (args: { department: number | { id: number } } | [department: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: toggleStatus.url(args, options),
    method: 'post',
})
 ...
 * @route '/departments/{department}/toggle-status'
 */
        toggleStatusForm.post = (args: { department: number | { id: number } } | [department: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: toggleStatus.url(args, options),
            method: 'post',
        })
...
/**
* @see \App\Http\Controllers\DepartmentController::getList
 * @see app/Http/Controllers/DepartmentController.php:359
 ...
 * @see app/Http/Controllers/DepartmentController.php:159
 ...
 * @see app/Http/Controllers/DepartmentController.php:239
 * @route '/departments/{department}'
 */
 ...
 * @see app/Http/Controllers/DepartmentController.php:306
 * @route '/departments/{department}'
 */
...
const DepartmentController = { toggleStatus, getList, index, create, store, show, edit, update, destroy }
