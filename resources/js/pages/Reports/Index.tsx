    ...
    return (
        <>
            ...
            <div className="p-6 space-y-6">
                ...
                {/* دو ستون: نمودار روزانه + اولویت */}
                <div className="grid grid-cols-3 gap-6">

                    {/* نمودار روزانه */}
                    <div className="col-span-2 bg-white rounded-lg shadow p-6">
                        <h2 className="text-sm font-semibold text-gray-600 mb-4">
                            نامه‌های ۳۰ روز اخیر
                        </h2>
                        <div className="flex items-end gap-1 h-32">
                            {Object.entries(daily).map(([date, count]) => (
                                <div
                                    ...
                                    title={`${date}: ${count} نامه`}
                                >
                                    <div
                                        className="w-full bg-blue-400 rounded-t transition-all hover:bg-blue-600"
                            ...
                            {Object.entries(byPriority).map(([priority, count]) => (
                                <div key={priority}>
                                    ...
                                    <div className="bg-gray-100 rounded-full h-2">
                                        <div
                                            className={`${PRIORITY_COLOR[priority] ?? 'bg-gray-400'} h-2 rounded-full`}
