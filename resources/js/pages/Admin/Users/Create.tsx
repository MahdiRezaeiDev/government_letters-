...
interface Props { roles: Role[]; organizations: Organization[]; departments: Department[]; positions: Position[]; }

interface UserForm {
    first_name: string; last_name: string; username: string; email: string;
    password: string; national_code: string; mobile: string;
    role: string; position_id: string; organization_id: string;
    status: 'active' | 'inactive' | 'suspended';
}

export default function Create({ roles, organizations, departments, positions }: Props) {
