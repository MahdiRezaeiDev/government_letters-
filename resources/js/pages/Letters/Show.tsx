            ...
            <div className="p-6 max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <div className="flex gap-2 flex-wrap">
                                ...
                                <span className={`text-xs px-2 py-1 rounded-full ${STATUS_COLOR[letter.final_status]}`}>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            <span className="text-gray-500">شماره نامه:</span>
                        ...
                        <div>
                            ...
                            <span className="mr-2 font-medium">{letter.date}</span>
                        </div>
                        <div>
                            <span className="text-gray-500">مهلت اقدام:</span>
                            <span className="mr-2 font-medium">
                                {letter.due_date ?? '---'}
                            </span>
                        </div>
                ...
                {letter.content && (
                    <div className="bg-white rounded-lg shadow p-6">
                        ...
                        <div
                            className="text-sm text-gray-700 leading-8 prose max-w-none"
