// resources/js/pages/archives/cases/edit.tsx
...
export default function CasesEdit({ archive, case: caseItem }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        title: caseItem.title,
        case_number: caseItem.case_number,
        description: caseItem.description || '',
        retention_period: caseItem.retention_period?.toString() || '',
        retention_unit: caseItem.retention_unit || 'years',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('archives.cases.update', { archive: archive.id, case: caseItem.id }));
    };

    return (
        <>
            <Head title={`ویرایش پرونده - ${caseItem.title}`} />
            ...
            <div className="max-w-2xl mx-auto py-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">ویرایش پرونده</h1>
                        ...
                        <div className="flex gap-3">
                            <button
                                type="button"
                                onClick={() => router.get(route('archives.cases.show', { archive: archive.id, case: caseItem.id }))}
