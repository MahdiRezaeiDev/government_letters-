...
export default function DepartmentsCreate({ organizations, parentDepartments, selectedOrganization, organizationUsers = [] }: Props) {
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
                                    ...
                                    <div className="p-6 space-y-5">
                                        ...
                                        {/* Reception User - only for root departments */}
                                        {!data.parent_id && (
                                            <div>
                        ...
                        <div className=" mt-5 rounded-2xl bg-white border-t border-slate-200 p-4 z-20">
                            <div className="flex gap-3 max-w-5xl mx-auto">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="flex-1 cursor-pointer flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition-colors disabled:opacity-50 shadow-sm"
                                >
